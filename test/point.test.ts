...
describe('Point', function () {
    ...
    describe('#add', function () {
        ...
        it('should accurately add g to itself', function () {
            ...
            p3.getX()
                .toString()
                .should.equal('89565891926547004231252920425935692360644145829622209833684329913297188986597')
            p3.getY()
                .toString()
    ...
    describe('#mul', function () {
        ...
        it('should accurately multiply g by n-1', function () {
            ...
            b.getX()
                .toString()
                .should.equal('55066263022277343669578718895168534326250603453777594175500187360389116729240')
            b.getY()
                .toString()
        ...
        it('should accurate multiply these problematic values related to a bug in bn.js', function () {
            ...
            ;(function () {
                const nhex = '6d1229a6b24c2e775c062870ad26bc261051e0198c67203167273c7c62538846'
                ...
                const p1 = g1.mul(n)
                const p2 = g2.mul(n)
                const pxhex = 'd6106302d2698d6a41e9c9a114269e7be7c6a0081317de444bb2980bf9265a01'
                const pyhex = 'e05fb262e64b108991a29979809fcef9d3e70cafceb3248c922c17d83d66bc9d'
            ...
            ;(function () {
                const nhex = 'f2cc9d2b008927db94b89e04e2f6e70c180e547b3e5e564b06b8215d1c264b53'
                const n = new Bn(nhex, 16)
                const g1 = Point.getG() // precomputed g
                const g2 = new Point().fromX(
                    false,
                ...
                const p1 = g1.mul(n)
                const p2 = g2.mul(n)
                const pxhex = 'e275faa35bd1e88f5df6e8f9f6edb93bdf1d65f4915efc79fd7a726ec0c21700'
                const pyhex = '367216cb35b086e6686d69dddd822a8f4d52eb82ac5d9de18fdcd9bf44fa7df7'
                p1.getX().toBuffer().toString('hex').should.equal(pxhex)
                p1.getY().toBuffer().toString('hex').should.equal(pyhex)
                p2.getX().toBuffer().toString('hex').should.equal(pxhex)
                p2.getY().toBuffer().toString('hex').should.equal(pyhex)
    ...
    describe('#mulAdd', function () {
        it('should get back a point', function () {
            ...
            const bn2 = new Bn(6)
            p1.mulAdd(bn1, p2, bn2)
                .getX()
                .toString()
                .should.equal(p1.mul(bn1).add(p2.mul(bn2)).getX().toString())
            p1.mulAdd(bn1, p2, bn2)
                .getY()
                .toString()
                .should.equal(p1.mul(bn1).add(p2.mul(bn2)).getY().toString())
        })
    })
    ...
    describe('#validate', function () {
        it('should validate this valid point', function () {
            ...
            const y = new Bn().fromBuffer(
                Buffer.from('4836ab292c105a711ed10fcfd30999c31ff7c02456147747e03e739ad527c380', 'hex')
            )
