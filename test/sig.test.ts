...
describe('Sig', () => {
    ...
    describe('#fromTxFormat', () => {
        it('should convert from this known tx-format buffer', () => {
            ...
            sig.r
                .toString()
                .should.equal('63173831029936981022572627018246571655303050627048489594159321588908385378810')
            sig.s
                .toString()
                .should.equal('4331694221846364448463828256391194279133231453999942381442030409253074198130')
    ...
    describe('#parseDer', () => {
        ...
        it('should parse this 69 byte signature', () => {
            ...
            parsed.s
                .toString()
                .should.equal('21463938592353267769710297084836796652964571266930856168996063301532842380538')
        })
        ...
        it('should parse this 68 byte signature', () => {
            ...
            parsed.s
                .toString()
                .should.equal('44212963026209759051804639008236126356702363229859210154760104982946304432721')
        })
    })
    ...
    describe('#toHex', () => {
        ...
        it('should convert these known r, s, nHashType values into a known signature', () => {
            const r = new Bn('63173831029936981022572627018246571655303050627048489594159321588908385378810')
            const s = new Bn('4331694221846364448463828256391194279133231453999942381442030409253074198130')
        ...
        it('should convert these known r and s values and guessed i values into signature', () => {
            const r = new Bn('63173831029936981022572627018246571655303050627048489594159321588908385378810')
            const s = new Bn('4331694221846364448463828256391194279133231453999942381442030409253074198130')
            let sig = Sig.fromObject({ r, s, recovery: 0 })
            sig.toHex().should.equal(
            ...
            sig = Sig.fromObject({ r, s, recovery: 1 })
            sig.toHex().should.equal(
            ...
            sig = Sig.fromObject({ r, s, recovery: 2 })
            sig.toHex().should.equal(
            ...
            sig = Sig.fromObject({ r, s, recovery: 3 })
            sig.toHex().should.equal(
    ...
    describe('#toBuffer', () => {
        ...
        it('should convert these known r and s values and guessed recovery values into signature', () => {
            const r = new Bn('63173831029936981022572627018246571655303050627048489594159321588908385378810')
            const s = new Bn('4331694221846364448463828256391194279133231453999942381442030409253074198130')
            let sig = Sig.fromObject({ r, s, recovery: 0 })
            sig.toBuffer()
