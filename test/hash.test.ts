...
describe('Hash', () => {
    ...
    it('should have the blockSize for some hash functions', () => {
    ...
    describe('@hmac', () => {
        it('should throw errors in these cases', () => {
            ;(function () {
    ...
    describe('@sha1', () => {
        it('should calculate the hash of this buffer correctly', () => {
    ...
    describe('@asyncSha1', () => {
        it('should compute the same as sha1', async () => {
        ...
        it('should compute the same as sha1 twice in a row', async () => {
            const sha1buf1 = Hash.sha1(buf)
    ...
    describe('@sha1Hmac', () => {
        ...
        it('should calculate this known empty test vector correctly', () => {
            const hex = 'b617318655057264e28bc0b6fb378c8ef146be00'
            Hash.sha1Hmac(Buffer.from('Hi There'), Buffer.from('0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b', 'hex'))
                .toString('hex')
                .should.equal(hex)
        })
    })

    describe('@asyncSha1Hmac', () => {
        it('should compute the same as sha1Hmac', async () => {
    ...
    describe('@asyncSha256', () => {
        it('should compute the same as sha256', async () => {
    ...
    describe('@sha256Hmac', () => {
        it('should compute this known empty test vector correctly', () => {
        ...
        it('should compute this known non-empty test vector correctly', () => {
    ...
    describe('@asyncSha256Hmac', () => {
        it('should compute the same as sha256Hmac', async () => {
            const data = Buffer.from('Hi There')
            const key = Buffer.from('0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b', 'hex')
    ...
    describe('@asyncSha256Sha256', () => {
        it('should compute the same as sha256Sha256', async () => {
    ...
    describe('@asyncRipemd160', () => {
        it('should compute the same as ripemd160', async () => {
    ...
    describe('@asyncSha512', () => {
        it('should compute the same as sha512', async () => {
    ...
    describe('@sha512Hmac', () => {
        it('should calculate this value where key size is the same as block size', () => {
        ...
        it('should calculate this known non-empty test vector correctly', () => {
            const hex =
    ...
    describe('@asyncSha512Hmac', () => {
        it('should compute the same as sha512Hmac', async () => {
            const data = Buffer.from('Hi There')
            const key = Buffer.from('0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b', 'hex')
