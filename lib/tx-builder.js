...
class TxBuilder extends Struct {
    constructor(tx = new Tx(), txIns = [], txOuts = [], uTxOutMap = new TxOutMap(), sigOperations = new SigOperations(), changeScript, changeAmountBn, feeAmountBn, feePerKbNum = Constants.feePerKbNum, nLockTime = 0, versionBytesNum = 1, sigsPerInput = 1, dust = Constants.dust, dustChangeToFees = false, hashCache = new HashCache()) {
        super({
            tx,
            txIns,
            txOuts,
